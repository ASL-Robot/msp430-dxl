...
uint8_t curl_data[41] =     { 40, THUMB_KNUCKLE, GET_1(XR2T(-2*PI/5)), GET_2(XR2T(-2*PI/5)), 0x75, 0x01,
...
uint8_t thumbs_up_data[41] =  { 40, THUMB_KNUCKLE, GET_1(XR2T(PI/2)), GET_2(XR2T(PI/2)), 0x75, 0x01,
...
uint8_t point_data[46] =    { 45, THUMB_BASE, GET_1(XR2T(-(PI/4))), GET_2(XR2T(-(PI/4))), 0x50, 0x01,
...
uint8_t okay_data[46] =     { 45, THUMB_BASE, GET_1(XR2T(-(PI/2))+2), GET_2(XR2T(-(PI/2))+2), 0x00, 0x02,
